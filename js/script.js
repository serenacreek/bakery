...
------------------------------------------------------ */
    ...
    $("html").niceScroll({
      cursorcolor:"#922b30", // Set cursor color
...
------------------------------------------------------*/
    ...
    // main directions
      map = new GMaps({
        el: '#map', lat: 26.520043, lng: -80.178998, zoom: /*13*/9, zoomControl : true, 
        zoomControlOpt: { style : 'SMALL', position: 'TOP_LEFT' }, panControl : false, scrollwheel: false
      });
    // add address markers
    map.addMarker({ lat: 26.520043, lng: -80.178998, title: 'BD InfoSys',
      infoWindow: { content: '<p>8327 Serena Creek Ave, Boynton Beach, FL 33473</p>' } });
